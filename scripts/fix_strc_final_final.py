...
def fix_everything_correctly(content):
    ...
    # 4. Citations & Footnotes (THE CRITICAL PART)
    ...
    if works_cited_start != -1:
        ...
        # Re-index based on appearance in text
        found_citations = []
    ...
    # 6. Ensure tables don't have extra blank lines
    lines = content.split('\n')
    fixed_lines = []
    in_table = False
...
fixed_content = fix_everything_correctly(original_content)
