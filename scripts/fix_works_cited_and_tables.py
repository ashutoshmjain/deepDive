...
def fix_works_cited(file_path):
    ...
    if works_cited_start_match:
        ...
        # Re-encode the entire works_cited section to strip any remaining hidden characters
        works_cited_raw = works_cited_raw.encode('utf-8').decode('utf-8')
        ...
        # Also, check for and remove duplicated table headers that might have been introduced
        # For example, in Table 2 and 3
        new_content = re.sub(r'(\| Channel \| Status \| Constraint \| Market Demand Driver \|\n\| :---- \| :---- \| :---- \| :---- \|\n)+', r'| Channel | Status | Constraint | Market Demand Driver |
| :---- | :---- | :---- | :---- |
', new_content)
        new_content = re.sub(r'(\| Ticker \| Name \| Type \| Dividend Rate \(Jan 2026\) \| Dividend Freq \| Strategic Role \|\n\| :---- \| :---- \| :---- \| :---- \| :---- \| :---- \|\n)+', r'| Ticker | Name | Type | Dividend Rate (Jan 2026) | Dividend Freq | Strategic Role |
| :---- | :---- | :---- | :---- | :---- | :---- |
', new_content)
