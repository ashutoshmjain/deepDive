...
<!-- VIDEO_STRIP_START -->
<div class="video-single-container" style="max-width: 500px; margin: 20px auto; position: relative; border-radius: 12px; overflow: hidden; background: #000; aspect-ratio: 1/1; display: flex; flex-direction: column; box-shadow: 0 4px 15px rgba(0,0,0,0.3);">
...
(function() {
  const init = () => {
    const vids = document.querySelectorAll('.video-single-container video');
    vids.forEach(v => { 
      v.muted = true; 
      v.play().catch(() => {}); 
    });
