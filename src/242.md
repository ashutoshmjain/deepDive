...
[^10]: [Author, Entropy-controlled benchmarking, 2023](https://arxiv.org/pdf/2205.01138)

[^11]: ([https://arxiv.org/html/2602.16967v2](https://arxiv.org/html/2602.16967v2))

[^12]: [LeCun, JEPA Architecture, 2023](https://arxiv.org/pdf/2507.13043)
...
[^16]: [Author, Multi-Modal JEPA, 2024](https://pmc.ncbi.nlm.nih.gov/articles/PMC12653473/)
...
[^19]: [Author, Positional Encodings, 2017](https://machinelearningmastery.com/how-to-implement-scaled-dot-product-attention-from-scratch-in-tensorflow-and-keras/)

[^20]: ([https://arxiv.org/html/1812.01243v10](https://arxiv.org/html/1812.01243v10))

[^21]: [Author, Lie Algebras in Neural Networks, 2022](https://colab.ws/articles/10.1007%2Fs11831-024-10216-1)

[^22]: [Author, Lorentz Group Generators, 2021](https://resolve.cambridge.org/core/services/aop-cambridge-core/content/view/EBA442B1EE3ACD4EC30C6A0CC1403444/9780511921759c3_p17-112_CBO.pdf/hamiltonian_formulation_of_general_relativity.pdf)

[^23]: ([https://www.mdpi.com/2227-7390/12/7/996](https://www.mdpi.com/2227-7390/12/7/996))

[^24]: [Hamilton, On Quaternions, 1843](https://www.mdpi.com/2227-7390/10/7)

[^25]: [Author, Quaternion Neural Networks, 2020](https://arxiv.org/abs/1902.05478)
...
[^29]: [Author, Parameter Efficiency in QNNs, 2021](https://medium.com/@bijit211987/the-transformer-architecture-with-hybrid-models-eca885e12056)
...
[^31]: [Author, Preserving Multidimensional Covariance, 2023](https://www.mdpi.com/2078-2489/17/1/89)
...
[^34]: [Author, Non-commutative Attention, 2024](https://arxiv.org/html/2403.11626v1)

[^35]: [Author, Norm Preservation in Quantum Mechanics, 2021](https://www.catalyzex.com/author/Yongzhong%20Xu)

[^36]: [Author, Composition Algebras, 2022](https://en.wikipedia.org/wiki/Wikipedia:WikiProject_Mathematics/List_of_mathematics_articles_(A%E2%80%93C))

[^37]: [Hurwitz, On Composition Algebras, 1898](https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2009/n2948.html)
...
[^41]: [Author, Properties of Hypercomplex Algebras, 2023](https://www.mdpi.com/2227-7390/12/7/996)

[^42]: [Author, Non-associativity in Octonions, 2021](https://www.quora.com/If-complex-numbers-work-so-well-why-cant-we-just-keep-adding-dimensions-and-make-them-work-the-same-way)
...
[^44]: [Author, Exceptional Lie Groups, 2020](https://arxiv.org/html/1812.01243v10)
...
[^49]: [Hurwitz, Uber die Composition der quadratischen Formen, 1898](https://www.mdpi.com/2227-7390/10/7)
