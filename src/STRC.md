...
**1. Series A Perpetual Strike Preferred Stock (STRK):**
This stock acts as a core component of the company's fixed-income offerings.
...
**2. Series A Perpetual Stream Preferred Stock (STRF / STRE):**
Designed for global reach, this series is issued in US Dollars (STRF) and Euros (STRE).
...
**3. “Stretch” Preferred Stock (STRC):**
The STRC instrument is highly innovative, branded as "Short Duration, High Yield Credit".
...
**4. Series A Perpetual Stride Preferred Stock (STRD):**
STRD introduces a specific risk/reward profile.
*   Rate: **10.00%** per annum.
