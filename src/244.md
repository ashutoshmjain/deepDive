...
<div class="video-carousel-container" style="display: flex; overflow-x: auto; scroll-snap-type: x mandatory; gap: 15px; padding: 20px 0; scroll-behavior: smooth;">
  <div style="flex: 0 0 60%; scroll-snap-align: center; position: relative; border-radius: 12px; overflow: hidden; background: #000; aspect-ratio: 1/1; display: flex; flex-direction: column; box-shadow: 0 4px 15px rgba(0,0,0,0.3);">
    <video src="ddma/docs/episodes/244/clips/244-1.mp4" style="width: 100%; height: 85%; object-fit: contain;" playsinline loop preload="auto" muted autoplay></video>
    <div style="height: 15%; background: #1a1a1a; color: #ccc; display: flex; align-items: center; justify-content: center; font-family: monospace; font-size: 12px; border-top: 1px solid #333;">244-1-Einstein-Magnet-Conductor</div>
  ...
  <div style="flex: 0 0 60%; scroll-snap-align: center; position: relative; border-radius: 12px; overflow: hidden; background: #000; aspect-ratio: 1/1; display: flex; flex-direction: column; box-shadow: 0 4px 15px rgba(0,0,0,0.3);">
    <video src="ddma/docs/episodes/244/clips/244-2.mp4" style="width: 100%; height: 85%; object-fit: contain;" playsinline loop preload="auto" muted autoplay></video>
    <div style="height: 15%; background: #1a1a1a; color: #ccc; display: flex; align-items: center; justify-content: center; font-family: monospace; font-size: 12px; border-top: 1px solid #333;">244-2-Galileo-Tied-Stones</div>
    <button class="vid-toggle" onclick="window.oph_play_toggle(this)" style="position: absolute; top: 10px; right: 10px; background: rgba(0,0,0,0.8); color: white; border: 2px solid white; border-radius: 50%; width: 45px; height: 45px; cursor: pointer; font-size: 22px; z-index: 100;">🔇</button>
  </div>
  <div style="flex: 0 0 60%; scroll-snap-align: center; position: relative; border-radius: 12px; overflow: hidden; background: #000; aspect-ratio: 1/1; display: flex; flex-direction: column; box-shadow: 0 4px 15px rgba(0,0,0,0.3);">
    <video src="ddma/docs/episodes/244/clips/244-4.mp4" style="width: 100%; height: 85%; object-fit: contain;" playsinline loop preload="auto" muted autoplay></video>
    <div style="height: 15%; background: #1a1a1a; color: #ccc; display: flex; align-items: center; justify-content: center; font-family: monospace; font-size: 12px; border-top: 1px solid #333;">244-4-Ad-Hoc-Hypothesis-Myth</div>
    <button class="vid-toggle" onclick="window.oph_play_toggle(this)" style="position: absolute; top: 10px; right: 10px; background: rgba(0,0,0,0.8); color: white; border: 2px solid white; border-radius: 50%; width: 45px; height: 45px; cursor: pointer; font-size: 22px; z-index: 100;">🔇</button>
  </div>
  <div style="flex: 0 0 60%; scroll-snap-align: center; position: relative; border-radius: 12px; overflow: hidden; background: #000; aspect-ratio: 1/1; display: flex; flex-direction: column; box-shadow: 0 4px 15px rgba(0,0,0,0.3);">
    <video src="ddma/docs/episodes/244/clips/244-5.mp4" style="width: 100%; height: 85%; object-fit: contain;" playsinline loop preload="auto" muted autoplay></video>
    <div style="height: 15%; background: #1a1a1a; color: #ccc; display: flex; align-items: center; justify-content: center; font-family: monospace; font-size: 12px; border-top: 1px solid #333;">244-5-Laudan-Empirical-Conceptual</div>
    <button class="vid-toggle" onclick="window.oph_play_toggle(this)" style="position: absolute; top: 10px; right: 10px; background: rgba(0,0,0,0.8); color: white; border: 2px solid white; border-radius: 50%; width: 45px; height: 45px; cursor: pointer; font-size: 22px; z-index: 100;">🔇</button>
  </div>
  <div style="flex: 0 0 60%; scroll-snap-align: center; position: relative; border-radius: 12px; overflow: hidden; background: #000; aspect-ratio: 1/1; display: flex; flex-direction: column; box-shadow: 0 4px 15px rgba(0,0,0,0.3);">
    <video src="ddma/docs/episodes/244/clips/244-6.mp4" style="width: 100%; height: 85%; object-fit: contain;" playsinline loop preload="auto" muted autoplay></video>
    <div style="height: 15%; background: #1a1a1a; color: #ccc; display: flex; align-items: center; justify-content: center; font-family: monospace; font-size: 12px; border-top: 1px solid #333;">244-6-CARS-Model-Planck-Principle</div>
    <button class="vid-toggle" onclick="window.oph_play_toggle(this)" style="position: absolute; top: 10px; right: 10px; background: rgba(0,0,0,0.8); color: white; border: 2px solid white; border-radius: 50%; width: 45px; height: 45px; cursor: pointer; font-size: 22px; z-index: 100;">🔇</button>
  </div>
  <div style="flex: 0 0 60%; scroll-snap-align: center; position: relative; border-radius: 12px; overflow: hidden; background: #000; aspect-ratio: 1/1; display: flex; flex-direction: column; box-shadow: 0 4px 15px rgba(0,0,0,0.3);">
    <video src="ddma/docs/episodes/244/clips/244-7.mp4" style="width: 100%; height: 85%; object-fit: contain;" playsinline loop preload="auto" muted autoplay></video>
    <div style="height: 15%; background: #1a1a1a; color: #ccc; display: flex; align-items: center; justify-content: center; font-family: monospace; font-size: 12px; border-top: 1px solid #333;">244-7-Copernican-Myth-Equant</div>
    <button class="vid-toggle" onclick="window.oph_play_toggle(this)" style="position: absolute; top: 10px; right: 10px; background: rgba(0,0,0,0.8); color: white; border: 2px solid white; border-radius: 50%; width: 45px; height: 45px; cursor: pointer; font-size: 22px; z-index: 100;">🔇</button>
  </div>
  <div style="flex: 0 0 60%; scroll-snap-align: center; position: relative; border-radius: 12px; overflow: hidden; background: #000; aspect-ratio: 1/1; display: flex; flex-direction: column; box-shadow: 0 4px 15px rgba(0,0,0,0.3);">
    <video src="ddma/docs/episodes/244/clips/244-8.mp4" style="width: 100%; height: 85%; object-fit: contain;" playsinline loop preload="auto" muted autoplay></video>
    <div style="height: 15%; background: #1a1a1a; color: #ccc; display: flex; align-items: center; justify-content: center; font-family: monospace; font-size: 12px; border-top: 1px solid #333;">244-8-Equant-Geometric-Cheat-Code</div>
    <button class="vid-toggle" onclick="window.oph_play_toggle(this)" style="position: absolute; top: 10px; right: 10px; background: rgba(0,0,0,0.8); color: white; border: 2px solid white; border-radius: 50%; width: 45px; height: 45px; cursor: pointer; font-size: 22px; z-index: 100;">🔇</button>
  </div>
  <div style="flex: 0 0 60%; scroll-snap-align: center; position: relative; border-radius: 12px; overflow: hidden; background: #000; aspect-ratio: 1/1; display: flex; flex-direction: column; box-shadow: 0 4px 15px rgba(0,0,0,0.3);">
    <video src="ddma/docs/episodes/244/clips/244-9.mp4" style="width: 100%; height: 85%; object-fit: contain;" playsinline loop preload="auto" muted autoplay></video>
    <div style="height: 15%; background: #1a1a1a; color: #ccc; display: flex; align-items: center; justify-content: center; font-family: monospace; font-size: 12px; border-top: 1px solid #333;">244-9-Newton-Descartes-Whirlpools</div>
    <button class="vid-toggle" onclick="window.oph_play_toggle(this)" style="position: absolute; top: 10px; right: 10px; background: rgba(0,0,0,0.8); color: white; border: 2px solid white; border-radius: 50%; width: 45px; height: 45px; cursor: pointer; font-size: 22px; z-index: 100;">🔇</button>
  </div>
  <div style="flex: 0 0 60%; scroll-snap-align: center; position: relative; border-radius: 12px; overflow: hidden; background: #000; aspect-ratio: 1/1; display: flex; flex-direction: column; box-shadow: 0 4px 15px rgba(0,0,0,0.3);">
    <video src="ddma/docs/episodes/244/clips/244-10.mp4" style="width: 100%; height: 85%; object-fit: contain;" playsinline loop preload="auto" muted autoplay></video>
    <div style="height: 15%; background: #1a1a1a; color: #ccc; display: flex; align-items: center; justify-content: center; font-family: monospace; font-size: 12px; border-top: 1px solid #333;">244-10-Phlogiston-Negative-Weight</div>
    <button class="vid-toggle" onclick="window.oph_play_toggle(this)" style="position: absolute; top: 10px; right: 10px; background: rgba(0,0,0,0.8); color: white; border: 2px solid white; border-radius: 50%; width: 45px; height: 45px; cursor: pointer; font-size: 22px; z-index: 100;">🔇</button>
  </div>
  <div style="flex: 0 0 60%; scroll-snap-align: center; position: relative; border-radius: 12px; overflow: hidden; background: #000; aspect-ratio: 1/1; display: flex; flex-direction: column; box-shadow: 0 4px 15px rgba(0,0,0,0.3);">
    <video src="ddma/docs/episodes/244/clips/244-12.mp4" style="width: 100%; height: 85%; object-fit: contain;" playsinline loop preload="auto" muted autoplay></video>
    <div style="height: 15%; background: #1a1a1a; color: #ccc; display: flex; align-items: center; justify-content: center; font-family: monospace; font-size: 12px; border-top: 1px solid #333;">244-12-Darwin-Imperfection-Design</div>
    <button class="vid-toggle" onclick="window.oph_play_toggle(this)" style="position: absolute; top: 10px; right: 10px; background: rgba(0,0,0,0.8); color: white; border: 2px solid white; border-radius: 50%; width: 45px; height: 45px; cursor: pointer; font-size: 22px; z-index: 100;">🔇</button>
  </div>
  <div style="flex: 0 0 60%; scroll-snap-align: center; position: relative; border-radius: 12px; overflow: hidden; background: #000; aspect-ratio: 1/1; display: flex; flex-direction: column; box-shadow: 0 4px 15px rgba(0,0,0,0.3);">
    <video src="ddma/docs/episodes/244/clips/244-13.mp4" style="width: 100%; height: 85%; object-fit: contain;" playsinline loop preload="auto" muted autoplay></video>
    <div style="height: 15%; background: #1a1a1a; color: #ccc; display: flex; align-items: center; justify-content: center; font-family: monospace; font-size: 12px; border-top: 1px solid #333;">244-13-Maxwell-Displacement-Current</div>
    <button class="vid-toggle" onclick="window.oph_play_toggle(this)" style="position: absolute; top: 10px; right: 10px; background: rgba(0,0,0,0.8); color: white; border: 2px solid white; border-radius: 50%; width: 45px; height: 45px; cursor: pointer; font-size: 22px; z-index: 100;">🔇</button>
  </div>
  <div style="flex: 0 0 60%; scroll-snap-align: center; position: relative; border-radius: 12px; overflow: hidden; background: #000; aspect-ratio: 1/1; display: flex; flex-direction: column; box-shadow: 0 4px 15px rgba(0,0,0,0.3);">
    <video src="ddma/docs/episodes/244/clips/244-14.mp4" style="width: 100%; height: 85%; object-fit: contain;" playsinline loop preload="auto" muted autoplay></video>
    <div style="height: 15%; background: #1a1a1a; color: #ccc; display: flex; align-items: center; justify-content: center; font-family: monospace; font-size: 12px; border-top: 1px solid #333;">244-14-Michelson-Morley-Duct-Tape</div>
    <button class="vid-toggle" onclick="window.oph_play_toggle(this)" style="position: absolute; top: 10px; right: 10px; background: rgba(0,0,0,0.8); color: white; border: 2px solid white; border-radius: 50%; width: 45px; height: 45px; cursor: pointer; font-size: 22px; z-index: 100;">🔇</button>
  </div>
  <div style="flex: 0 0 60%; scroll-snap-align: center; position: relative; border-radius: 12px; overflow: hidden; background: #000; aspect-ratio: 1/1; display: flex; flex-direction: column; box-shadow: 0 4px 15px rgba(0,0,0,0.3);">
    <video src="ddma/docs/episodes/244/clips/244-15.mp4" style="width: 100%; height: 85%; object-fit: contain;" playsinline loop preload="auto" muted autoplay></video>
    <div style="height: 15%; background: #1a1a1a; color: #ccc; display: flex; align-items: center; justify-content: center; font-family: monospace; font-size: 12px; border-top: 1px solid #333;">244-15-Einstein-1905-Symmetry-Attack</div>
    <button class="vid-toggle" onclick="window.oph_play_toggle(this)" style="position: absolute; top: 10px; right: 10px; background: rgba(0,0,0,0.8); color: white; border: 2px solid white; border-radius: 50%; width: 45px; height: 45px; cursor: pointer; font-size: 22px; z-index: 100;">🔇</button>
  </div>
  <div style="flex: 0 0 60%; scroll-snap-align: center; position: relative; border-radius: 12px; overflow: hidden; background: #000; aspect-ratio: 1/1; display: flex; flex-direction: column; box-shadow: 0 4px 15px rgba(0,0,0,0.3);">
    <video src="ddma/docs/episodes/244/clips/244-16.mp4" style="width: 100%; height: 85%; object-fit: contain;" playsinline loop preload="auto" muted autoplay></video>
    <div style="height: 15%; background: #1a1a1a; color: #ccc; display: flex; align-items: center; justify-content: center; font-family: monospace; font-size: 12px; border-top: 1px solid #333;">244-16-Blackbody-Radiation-Planck</div>
    <button class="vid-toggle" onclick="window.oph_play_toggle(this)" style="position: absolute; top: 10px; right: 10px; background: rgba(0,0,0,0.8); color: white; border: 2px solid white; border-radius: 50%; width: 45px; height: 45px; cursor: pointer; font-size: 22px; z-index: 100;">🔇</button>
  </div>
  <div style="flex: 0 0 60%; scroll-snap-align: center; position: relative; border-radius: 12px; overflow: hidden; background: #000; aspect-ratio: 1/1; display: flex; flex-direction: column; box-shadow: 0 4px 15px rgba(0,0,0,0.3);">
    <video src="ddma/docs/episodes/244/clips/244-17.mp4" style="width: 100%; height: 85%; object-fit: contain;" playsinline loop preload="auto" muted autoplay></video>
    <div style="height: 15%; background: #1a1a1a; color: #ccc; display: flex; align-items: center; justify-content: center; font-family: monospace; font-size: 12px; border-top: 1px solid #333;">244-17-Feynman-Quantum-Electrodynamics</div>
    <button class="vid-toggle" onclick="window.oph_play_toggle(this)" style="position: absolute; top: 10px; right: 10px; background: rgba(0,0,0,0.8); color: white; border: 2px solid white; border-radius: 50%; width: 45px; height: 45px; cursor: pointer; font-size: 22px; z-index: 100;">🔇</button>
  </div>
  <div style="flex: 0 0 60%; scroll-snap-align: center; position: relative; border-radius: 12px; overflow: hidden; background: #000; aspect-ratio: 1/1; display: flex; flex-direction: column; box-shadow: 0 4px 15px rgba(0,0,0,0.3);">
    <video src="ddma/docs/episodes/244/clips/244-18.mp4" style="width: 100%; height: 85%; object-fit: contain;" playsinline loop preload="auto" muted autoplay></video>
    <div style="height: 15%; background: #1a1a1a; color: #ccc; display: flex; align-items: center; justify-content: center; font-family: monospace; font-size: 12px; border-top: 1px solid #333;">244-18-Architecture-Demolition-Summary</div>
    <button class="vid-toggle" onclick="window.oph_play_toggle(this)" style="position: absolute; top: 10px; right: 10px; background: rgba(0,0,0,0.8); color: white; border: 2px solid white; border-radius: 50%; width: 45px; height: 45px; cursor: pointer; font-size: 22px; z-index: 100;">🔇</button>
  </div>
</div>
...
1. **Move 1: Establishing a Territory:** Summarizing the current consensus and outlining the bounds of the field [^8] , [^10] .
2. **Move 2: Establishing a Niche:** Pointing out a gap, contradiction, anomaly, or fundamental flaw in that consensus (counter-claiming) [^9] , [^10] .
3. **Move 3: Occupying the Niche:** Introducing the author's work as the necessary, inevitable resolution to the identified gap [^9] , [^10] .
...
1. **The Retardation Argument:** Because the lighter stone naturally falls slower, it will create drag on the heavier stone, pulling the string taut. Therefore, the combined system should be retarded by the slower object and fall at a speed *intermediate* between the heavy stone and the light stone (i.e., a speed less than eight) [^27] .
2. **The Additive Weight Argument:** The two stones tied together create a new, composite system that is physically heavier than the heavy stone alone. Therefore, according to Aristotle’s absolute rule that heavier bodies fall faster, the combined system must fall *faster* than the heavy stone alone (i.e., a speed greater than eight) [^27] .
...
In the realm of nineteenth-century electrodynamics, James Clerk Maxwell provided one of the most elegant examples of theoretical course-correction through the identification of a conceptual hole. Classical electromagnetism relied heavily on Ampere's Law ($\nabla \times \mathbf{H} = \mathbf{J}$), which successfully described the magnetic field ($\mathbf{H}$) generated by a steady, continuous electric current density ($\mathbf{J}$) [^45] , [^46] , [^47] .
...
Maxwell pointed out a fatal logical flaw: if one applies the mathematical operator of divergence to both sides of Ampere's Law, the left side—the divergence of the curl of the magnetic field ($\nabla \cdot (\nabla \times \mathbf{H})$)—is a mathematical identity that always equals exactly zero [^46] , [^49] , [^47] . Therefore, the right side ($\nabla \cdot \mathbf{J}$) must also equal zero. For steady currents, this is true. Yet, the fundamental law of the conservation of charge (the continuity equation) dictates that for time-varying currents, the divergence of the current density is *not* zero, but rather equal to the negative rate of change of the charge density ($-\partial \rho / \partial t$) [^50] , [^41] , [^23] . This meant that Ampere's Law was strictly inconsistent with the conservation of charge unless the charge density was totally static [^45] , [^46] , [^49] .

Maxwell’s attack vector was not based on a new experimental discrepancy, but on a purely logical and mathematical contradiction within the existing laws of physics [^46] . To resolve the glaring hole he had highlighted, Maxwell challenged the community with a mathematical fix: the introduction of a new term, the "displacement current" ($\partial \mathbf{D} / \partial t$), which accounted for the changing electric flux across the capacitor gap [^40] , [^50] , [^41] . This solution not only restored symmetry and mathematical consistency to Ampere's law, but it led directly to Maxwell's crowning achievement: the prediction that changing electric and magnetic fields propagate as electromagnetic waves at the speed of light [^45] , [^48] .
...
1. **Quantum Measurement:** Standard quantum mechanics relies on unitary evolution supplemented by an awkward, ad-hoc measurement postulate that has never fit cleanly into the math. OPH attacks this by making definiteness a property of records carried by each local observer patch. In OPH, "collapse" is not a magical global event, but simply record-consistency across patch overlaps, reframing QM as patch-relationship bookkeeping rather than a "God's-eye" wavefunction of the entire universe [^62] , [^64] . 
...
3. **Cosmological Constant Fine-Tuning:** The current paradigm faces a massive anomaly where quantum field theory predicts a vacuum energy that is catastrophically too large (by a factor of $\sim 10^{120}$). OPH dissolves this premise entirely: QFT vacuum energy is not fundamental stress-energy, but rather a global screen-capacity closure datum tied to de Sitter entropy, rendering the "smallness" an inherent feature of the architecture rather than an unexplained cancellation [^62] , [^63] .
4. **Black Hole Information Paradox:** The famous paradox is driven by treating the black hole interior and exterior as independent tensor factors. OPH changes the structural bookkeeping by asserting that fundamental information is always on the screen [^73] , [^76] . Interior data is encoded and recoverable from the boundary (with no "second vault"), meaning naive factorization was the wrong starting point [^62] , [^63] . 
5. **Dark Matter Anomalies:** Standard cosmology relies on an unseen gravitating sector, but particle searches have found no candidates. OPH attacks this by offering a third route: the "extra gravity" can include information-defect stress stemming from imperfect record repair on overlap collars [^62] , [^63] . This stress is electromagnetically dark by construction but gravitates within the effective stress bookkeeping, naturally reproducing observed galaxy acceleration scales without needing new invisible particles [^62] , [^63] .
6. **Arbitrary Laws and Structure:** Mainstream physics accepts the Standard Model gauge group and General Relativity as given axioms with arbitrarily tuned parameters. OPH leverages this gap by deriving these public-world regularities—such as the Standard Model particle masses and gauge structure—from first principles. OPH argues that the laws of physics are simply the stable normal forms that survive harsh intersubjective consistency constraints during the overlap and repair process [^62] , [^63] .
...
[^1]: [Cambridge Core, Kuhn's Structure of Scientific Revolutions at 60, Year](https://www.cambridge.org/core/books/kuhns-the-structure-of-scientific-revolutions-at-60/kuhn-and-the-history-of-science/6F6E79041D791A7AD342DAB4F74EC22A)

[^2]: [OpenEdition, RFSIC Article on Rhetoric of Science, Year](https://journals.openedition.org/rfsic/10350)

[^3]: [ResearchGate, Manufactured Scientific Controversy, Year](https://www.researchgate.net/publication/236710036_Manufactured_Scientific_Controversy_Science_Rhetoric_and_Public_Debate)

[^4]: [PAN, Scientific Foundation Aspects, Year](https://journals.pan.pl/Content/102203?format_id=1)

[^5]: [YorkU, Laudan's Problems, Year](http://www.yorku.ca/jagdish/docs/Laudans%20Problems.pdf)

[^6]: [Rational Realm, Larry Laudan conceptual problems, Year](https://www.rationalrealm.com/philosophy/reviews/historical-introduction-philosophy-science-page15.html)

[^7]: [Sanath Thilakarathna, Quantum Physics Post, 2025](https://sanaththilakarathna.me/blog/2025/quantum-physiscs-post-02-copy/)

[^8]: [ArXiv, Swales CARS model, 2026](https://arxiv.org/html/2605.25964v1)

[^9]: [ResearchGate, Application of Swales' model, Year](https://www.researchgate.net/publication/368209422_The_application_of_Swales'_model_in_writing_a_research_article_introduction)

[^10]: [Dialnet, Swales CARS model, Year](https://dialnet.unirioja.es/descarga/articulo/8842711.pdf)

[^11]: [Triple C, Scientific Writing Crisis, Year](https://www.triple-c.at/index.php/tripleC/article/view/1835/1701)

[^12]: [Wikipedia, Planck's principle, Year](https://en.wikipedia.org/wiki/Planck%27s_principle)

[^13]: [Wikiquote, Max Planck, Year](https://en.wikiquote.org/wiki/Max_Planck)

[^14]: [Wikiquote, Max Planck Scientific Truth, Year](https://en.wikiquote.org/wiki/Max_Planck)

[^15]: [Triple C, Scientific Writing Crisis, Year](https://www.triple-c.at/index.php/tripleC/article/view/1835/1701)

[^16]: [Wikipedia, Planck's principle, Year](https://en.wikipedia.org/wiki/Planck%27s_principle)

[^17]: [Wikipedia, De revolutionibus orbium coelestium, Year](https://en.wikipedia.org/wiki/De_revolutionibus_orbium_coelestium)

[^18]: [FAS37, The Copernican Revolution, Year](https://www.fas37.org/wp/the-copernican-revolution/)

[^19]: [Grokipedia, De revolutionibus orbium coelestium, Year](https://grokipedia.com/page/De_revolutionibus_orbium_coelestium)

[^20]: [Harvard DASH, Copernicus equant critique, Year](https://dash.harvard.edu/bitstreams/7312037c-4902-6bd4-e053-0100007fdf3b/download)

[^21]: [Stanford Encyclopedia of Philosophy, Copernicus, 2014](https://plato.stanford.edu/archives/fall2014/entries/copernicus/)

[^22]: [Lotz in Translation, Review On the Revolutions, 2018](https://lotzintranslation.com/2018/08/31/review-on-the-revolutions-of-heavenly-spheres/)

[^23]: [ArXiv, Galileo Dialogue tower argument critique, 2023](https://arxiv.org/pdf/2304.06860)

[^24]: [Wikipedia, Galileo's Leaning Tower of Pisa experiment, Year](https://en.wikipedia.org/wiki/Galileo%27s_Leaning_Tower_of_Pisa_experiment)

[^25]: [UPitt Press, Galileo and the Leaning Tower, 2018](https://upittpress.org/wp-content/uploads/2018/07/9780822944072exr.pdf)

[^26]: [TAU, Galileo's Dialogue on the Two Chief World Systems, Year](https://www.tau.ac.il/education/muse/museum/galileo/the_dialogue.html)

[^27]: [Wikipedia, Quantum electrodynamics, Year](https://en.wikipedia.org/wiki/Quantum_electrodynamics)

[^28]: [Library of Congress, Cartesian Vortices, Year](https://www.loc.gov/static/collections/finding-our-place-in-the-cosmos-with-carl-sagan/articles-and-essays/modeling-the-cosmos/physical-astronomy-for-the-mechanistic-universe.html)

[^29]: [Wikipedia, Philosophiæ Naturalis Principia Mathematica, Year](https://en.wikipedia.org/wiki/Philosophi%C3%A6_Naturalis_Principia_Mathematica)

[^30]: [Corpus Newtonicum, All was light but was it?, 2015](https://corpusnewtonicum.wordpress.com/2015/01/13/all-was-light-but-was-it/)

[^31]: [New Science Theory, Isaac Newton Principia Descartes, Year](https://www.new-science-theory.com/isaac-newton-principia-descartes.php)

[^32]: [Frost-Arnold, MMS Lecture 12, Year](https://people.hws.edu/gfrost-arnold/MMSLecture12.htm)

[^33]: [Encyclopedia.com, Rise and Fall of Phlogiston Theory, Year](https://www.encyclopedia.com/science/encyclopedias-almanacs-transcripts-and-maps/rise-and-fall-phlogiston-theory)

[^34]: [History of Science, Lavoisier Friends, Year](http://historyofscience.free.fr/Lavoisier-Friends/a_chap2_lavoisier.html)

[^35]: [Encyclopedia.com, Rise and Fall of Phlogiston Theory, Year](https://www.encyclopedia.com/science/encyclopedias-almanacs-transcripts-and-maps/rise-and-fall-phlogiston-theory-fire)

[^36]: [NIScPR, IJCT Article on Phlogiston, 2004](https://nopr.niscpr.res.in/bitstream/123456789/9538/1/IJCT%2011(5)%20732-743.pdf)

[^37]: [Huxley Media, Revelations in Science, Year](https://huxley.media/en/revelations-in-science-how-phlogiston-mysteriously-evaporated-from-physics-and-chemistry/)

[^38]: [PhilSci Archive, The Purloined Referent, Year](https://philsci-archive.pitt.edu/5076/1/The_Purloined_Referent.pdf)

[^39]: [UMich, Darwin's Causal Argument Against Creationism, Year](https://journals.publishing.umich.edu/phimp/article/id/930/)

[^40]: [GRISDA, Origins 62006, 2006](https://www.grisda.org/origins-62006)

[^41]: [Oikos Journal, Darwin's Origin Species Notes, Year](https://www.oikosjournal.org/blog/darwins-origin-species-notes-your-reading-group-updated)

[^42]: [UMich, Darwin's Causal Argument Against Creationism (Full), Year](https://journals.publishing.umich.edu/phimp/article/id/930/)

[^43]: [Medium, SciComm Book Reviews, Year](https://medium.com/scicomm-book-reviews/scientists-politics-and-the-rhetoric-of-public-controversy-e0570e1e8d6d)

[^44]: [Darwin Online, Editorial Introductions, Year](https://darwin-online.org.uk/EditorialIntroductions/Chancellor_vanWyhe_Origin1st.html)

[^45]: [AskFilo, Explain the inconsistency of Ampere's law, Year](https://askfilo.com/user-question-answers-smart-solutions/explain-the-inconsistency-of-amperes-law)

[^46]: [Scribd, Inconsistency in Maxwell's equations, Year](https://www.scribd.com/document/828585843/sv-34inconsistency-in-maxwells-equations)

[^47]: [Physics Pages, Maxwell's correction to Ampere's law, 2021](https://physicspages.com/pdf/Electrodynamics/Maxwell's%20correction%20to%20Amp%C3%A8re's%20law%20-%20displacement%20current.pdf)

[^48]: [Reddit, The logic behind Maxwell's correction, Year](https://www.reddit.com/r/AskPhysics/comments/1kxmwra/the_logic_behind_maxwells_correction_to_amp%C3%A8res/)

[^49]: [MIT, Lecture 19, Year](https://web.mit.edu/sahughes/www/8.022/lec19.pdf)

[^50]: [Darwin Project, Essay Natural Selection Natural Theology, Year](https://www.darwinproject.ac.uk/commentary/religion/essays-reviews-asa-gray/essay-natural-selection-natural-theology)

[^51]: [Author Unknown, The 1905 Special Relativity paper, Year](https://vixra.org/pdf/2304.0178v1.pdf)

[^52]: [Author Unknown, Einstein's Path to Special Relativity, Year](https://arxiv.org/html/2510.20695v1)

[^53]: [Author Unknown, Einstein 1905: The Theory of Relativity Is Born, 2015](https://www.researchgate.net/publication/279367321_Einstein_1905_The_Theory_of_Relativity_Is_Born)

[^54]: [Wikipedia, Moving magnet and conductor problem, 2023](https://en.wikipedia.org/wiki/Moving_magnet_and_conductor_problem)

[^55]: [Stephen E. Robbins, Einstein SR and Maxwell's Ether, 2012](http://www.stephenerobbins.com/uploads/7/3/2/9/73295531/einstein-maxwell.pdf)

[^56]: [Wikipedia, Moving magnet and conductor problem, 2023](https://en.wikipedia.org/wiki/Moving_magnet_and_conductor_problem)

[^57]: [Grokipedia, Photoelectric effect, Year](https://grokipedia.com/page/Photoelectric_effect)

[^58]: [FJCollazo, Einstein, Year](http://www.fjcollazo.com/documents/Einstein.htm)

[^59]: [AIP, Einstein Photoelectric Essay, Year](https://history.aip.org/exhibits/einstein/essay-photoelectric.htm)

[^60]: [Britannica, Wave-particle duality, Year](https://www.britannica.com/science/wave-particle-duality)

[^61]: [EBSCO, Blackbody radiation, Year](https://www.ebsco.com/research-starters/physics/blackbody-radiation)

[^62]: [Bohrium, Planck's quantum hypothesis, Year](https://www.bohrium.com/en/sciencepedia/feynman/keyword/planck_s_quantum_hypothesis)

[^63]: [Sanath Thilakarathna, Quantum Physics Post, 2025](https://sanaththilakarathna.me/blog/2025/quantum-physiscs-post-02-copy/)

[^64]: [Science Ready, Quantum Theory and Wiens Law, Year](https://scienceready.com.au/pages/quantum-theory-and-wiens-law)

[^65]: [AIP, Einstein Photoelectric Essay, Year](https://history.aip.org/exhibits/einstein/essay-photoelectric.htm)

[^66]: [Bohrium, Planck's quantum hypothesis, Year](https://www.bohrium.com/en/sciencepedia/feynman/keyword/planck_s_quantum_hypothesis)

[^67]: [ResearchGate, Reconstruction of the history of the photoelectric effect, Year](https://www.researchgate.net/publication/229455282_Reconstruction_of_the_history_of_the_photoelectric_effect_and_its_implications_for_general_physics_textbooks)

[^68]: [Grokipedia, Photoelectric effect, Year](https://grokipedia.com/page/Photoelectric_effect)

[^69]: [Logos Journal, Lawrence M. Krauss Quantum Man, Year](https://logosjournal.com/article/lawrence-m-krauss-quantum-man)

[^70]: [Richard Feynman, Nobel Lecture, 1965](https://www.nobelprize.org/prizes/physics/1965/feynman/lecture/)

[^71]: [Wikipedia, Quantum electrodynamics, Year](https://en.wikipedia.org/wiki/Quantum_electrodynamics)

[^72]: [Logos Journal, Lawrence M. Krauss Quantum Man, Year](https://logosjournal.com/article/lawrence-m-krauss-quantum-man)

[^73]: [Medium, Observers are all you need, Year](https://muellerberndt.medium.com/observers-are-all-you-need-how-observer-synchronization-creates-all-of-physics-8ebb7e9783e7)

[^74]: [Medium, How Observer Path Holography Improves on the Standard Model, Year](https://muellerberndt.medium.com/how-observer-path-holography-improves-on-the-standard-model-and-general-relativity-c971c376027e)

[^75]: [GitHub, Observer Patch Holography, Year](https://github.com/FloatingPragma/observer-patch-holography)

[^76]: [Blogspot, Observer Patch Holography, 2026](http://fineartdrawinglca.blogspot.com/2026/04/observer-patch-holography.html)

[^77]: [Springer, Scientists Politics and the Rhetoric of Public Controversy, Year](https://www.springerprofessional.de/en/scientists-politics-and-the-rhetoric-of-public-controversy/51316246)

[^78]: [TAU, The Dialogue, Year](https://www.tau.ac.il/education/muse/museum/galileo/the_dialogue.html)

[^79]: [KU, Scientists Politics and the Rhetoric of Public Controversy, 2025](https://comm.ku.dk/calendar/2025/scientists-politics-and-the-rhetoric-of-public-controversy/)